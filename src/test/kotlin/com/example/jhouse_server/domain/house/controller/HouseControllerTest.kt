...
internal class HouseControllerTest @Autowired constructor(
    ...
    private fun customMyPageResponseFieldSnippet(): Array<FieldDescriptor> {
        return arrayOf(
                ...
                fieldWithPath("count.cntAll").description("전체 개수 (totalElements와 동일한 값)"),
                fieldWithPath("count.cntApply").description("승인중 게시물 개수"),
                fieldWithPath("count.cntOngoing").description("판매중 게시물 개수"),
                fieldWithPath("count.cntCompleted").description("판매완료 게시물 개수"),
                fieldWithPath("last").description(""),
                fieldWithPath("totalPages").description(""),
                fieldWithPath("totalElements").description(""),
                fieldWithPath("size").description(""),
